      ...
      @else
                        ...
                        <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                              <h4 class="heading">
                                  {{ __('DOCUMENTS NEEDS TO BE SUBMITTED') }} *
                              </h4>
                            </div>
                          </div></br></br>
                          <div class="right-area">
                            <ol>
                                <li>
                                  {{ __('The front view photograph of the shop/establishment, with the board/name in local language') }} 
                              </li>
                                <li>
                                  {{ __('Certificate of Incorporation') }} 
                             </li>
                                <li>
                                  {{ __('AOA/MOA of the company/LLP agreement of the company') }} 
                            </li>
                              <li>
                                  {{ __(' A copy of the PAN card of the business owner/business') }} 
                              </li>
                                <li>
                                  {{ __('Copy of the Partners’ consent or the Board resolution') }} 
                             </li>
                                <li> 
                                  {{ __('List of partners/directors, along with their address & ID proof') }} 
                              </li>
                                  <li>
                                  {{ __('Proof of Address of the company /proprietorship/partnership/LLP ( lease deed/utility bills etc)') }} 
                           </li>
                                <li> 
                                  {{ __(' Details of the existing employees') }} 
                           </li>
                            </ol>
